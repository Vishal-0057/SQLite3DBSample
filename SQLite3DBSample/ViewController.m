...
- (void)viewDidLoad
{
   ...
   // self.dbManager = [[DBManager alloc] initWithDatabaseFilename:@"sampledb.sql"];
    self.dbManager = [[DBManager alloc] initWithDatabaseFilename:@"ezdeal.db"];
...
-(void)loadData{
   ...
   // NSString *query = @"select * from peopleInfo";
     NSString *query = @"select * from country_records";
...
//    NSInteger indexOfAge = [self.dbManager.arrColumnNames indexOfObject:@"age"];
       NSInteger indexOfFirstname = [self.dbManager.arrColumnNames indexOfObject:@"country_name"];
        NSInteger indexOfLastname = [self.dbManager.arrColumnNames indexOfObject:@"country_code"];
        NSInteger indexOfAge = [self.dbManager.arrColumnNames indexOfObject:@"dial_code"];
